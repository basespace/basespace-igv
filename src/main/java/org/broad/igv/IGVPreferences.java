 ...
 * string length in the default Linux implementation. of Preferences
 * 
 * @author jrobinso
 */
public class IGVPreferences
{
    ...
    /**
     * Load an override preference file. These preferences to not persist as
     * user preferences.
     * 
     * @param path
     */
    ...
    /**
     * @param prefFileName
     *            either a comma delimited list of key-value pairs, or a path to
     *            a properties file
     * @param override
     */
