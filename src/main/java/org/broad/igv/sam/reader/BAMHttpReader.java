...
public class BAMHttpReader implements AlignmentReader
{
    ...
    protected static Hashtable<String, File> indexFileCache = new Hashtable<String, File>();
    ...
    public BAMHttpReader(ResourceLocator locator, boolean requireIndex) throws IOException
    {
        ...
        if (requireIndex)
        {
            ...
            // SeekableStream ss = new
            // SeekableBufferedStream(getSeekableStream(url));
     ...
     * 
     * @param timeLimit
     *            Minimum age to delete. If null, default is 1 day
     * @throws IOException
     */
    ...
    protected File getIndexFile(URL url, String indexPath) throws IOException
    {
    ...
    protected File getTmpIndexFile(String bamURL) throws IOException
    {
    ...
    protected void loadIndexFile(String path, String indexPath, File indexFile) throws IOException
    {
        InputStream is = null;
