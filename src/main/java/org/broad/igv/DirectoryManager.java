...
public class DirectoryManager {
    ...
    private static File BASESPACE_DIRECTORY;
    ...
    public static synchronized File getBaseSpaceCacheRootDirectory() 
    {
        File file = new File(getUserDirectory(),"BaseSpace.cache");
        file.mkdirs();
        return file;
    }
