...
public abstract class XYPlotRenderer extends DataRenderer
{
    ...
    public void renderAxis(Track track, RenderContext context, Rectangle arect)
    {
        ...
        Color labelColor = prefs.getAsBoolean(PreferenceManager.CHART_COLOR_TRACK_NAME) ? track.getColor()
                : Color.black;
    ...
    public void renderBorder(Track track, RenderContext context, Rectangle arect)
    {
        ...
        if (adjustedRect.getHeight() >= 10)
        {
            ...
            Color borderColor = (prefs.getAsBoolean(PreferenceManager.CHART_COLOR_BORDERS) && track.getAltColor() == track
                    .getColor()) ? track.getColor() : Color.lightGray;
            ...
            {
                borderGraphics.drawLine(adjustedRect.x, adjustedRect.y + adjustedRect.height, adjustedRect.x
                        + adjustedRect.width, adjustedRect.y + adjustedRect.height);
            }
        }
        /*
         * (CHART_DRAW_TOP_BORDER));
         * prefs.setDrawBottomBorder(getBooleanPreference
         ...
         * prefs
         * .setColorTrackName(getBooleanPreference(CHART_COLOR_TRACK_NAME));
