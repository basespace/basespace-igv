...
public class FeatureUtils {
    ...
    protected static Logger log = Logger.getLogger(FeatureUtils.class);
    ...
    public static Feature getFeatureAt(double position, int buffer, List<? extends Feature> features)
    {
       ...
       // log.info("get feature at " + position + ",start=" + startIdx + ",end=" + endIdx + ",featuresSize="
          ///      + features.size());
        ...
        while (startIdx != endIdx)
        {
            ...
            //log.info("IDX=" + idx + " Feature start " + effectiveStart + " to end " + effectiveEnd + ",pos=" + position  + ",buffer=" + buffer);
